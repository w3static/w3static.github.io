...
if ($('#logoslide .owl-carousel').html() != undefined) {
    $('#logoslide .owl-carousel').owlCarousel({
        loop: true,
        autoplay: true,
        autoHeight: true,
        lazyLoad: true,
...
$(function() {
  if ($('#sidebar').length) { // Ganti "#sidebar" dengan ID tertentu
    ...
    $(window).scroll(function() {
      var limit = $('#logoslide').offset().top - stickyHeight - headerHeight; // Jarak berhenti di "#footer-wrapper"
